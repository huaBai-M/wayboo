$(function () {
    ...
    $(window).scroll(function () {
        ...
        rolling(".help",300,function(){
            window.scrollReveal = new scrollReveal();
        })
        rolling(".concat",300,function(){
            window.scrollReveal = new scrollReveal();
        })
        rolling(".service",300,function(){
            window.scrollReveal = new scrollReveal();
        })
        rolling(".system",300,function(){
            window.scrollReveal = new scrollReveal();
        })
          rolling(".help_net",300,function(){
            window.scrollReveal = new scrollReveal();
        }) 
         rolling(".net_d",300,function(){
            window.scrollReveal = new scrollReveal();
        }) 
